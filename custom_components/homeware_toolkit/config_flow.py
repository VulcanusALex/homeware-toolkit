"""Config flow for homeware-toolkit."""
...
class HomewareConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for homeware-toolkit."""
    ...
    def async_get_options_flow(
        ...
        return HomewareOptionsFlow(config_entry)


class HomewareOptionsFlow(config_entries.OptionsFlow):
    """Handle options."""
