"""Unified CLI for home-gateway-toolkit.

Usage: home-gateway [--base-url URL] [--json] [--quiet] [--version] <command> [options]
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="home-gateway", description=__doc__,
    ...
    p.add_argument("--tls-fingerprint",
                   help="pin the gateway certificate SHA-256 fingerprint "
                        "(see 'home-gateway session fingerprint')")
    ...
    p_setup.add_argument("--key", default="~/.home-gateway-toolkit/id_rsa",
    ...
    p_audit.add_argument("--state-file",
                         default="~/.home-gateway-toolkit/audit-state.json")
    ...
    p_ww.add_argument("--state-file",
                      default="~/.home_gateway_wanwatch_state.json")
    ...
    for name in ("apply", "diff"):
        ...
        p_cfg.add_argument("-f", "--file", required=True,
                           help="path to the JSON config (see examples/home_gateway.json)")
    ...
    s_wg.add_argument("--out-dir", default="~/.home-gateway-toolkit/wireguard",
